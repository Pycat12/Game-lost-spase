...
def gun_kill(stats, screen, sc, gun, inos, bulets):
    """столкновение пули и армии"""
...
def udate_inos(stats, screen, sc, gun, inos, bullets):
...
def create_army(screen, inos):
    ...
    number_ino_y = int((700 - 400 - 2 * ino_height) / ino_height)
